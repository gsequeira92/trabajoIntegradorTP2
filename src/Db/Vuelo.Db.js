...
const { crearVuelo } = require('/src/estudiantes/modelos/Vuelo.js')
...
async function crearVueloDaoDb(cnxString, dbName, collectionName) {
    ...
    return {
        ...
        getAll: async () => {
            ...
            const reservas = registrosEnColeccion.map(reg => crearVuelo(reg))
            return reservas
        },
        getById: async (unId) => {
